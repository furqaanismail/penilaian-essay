                ...
                <div class="row">
                    <div class="col-lg my-4">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="/mahasiswa/proses_register">
                                @csrf
                                <div class="form-group">
                                    <input type="name" class="form-control form-control-user" id="name" name="nim" placeholder="Nim">
                                </div>
                                <div class="form-group">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="/mahasiswa/auth">Already have an account? Login!</a>
                            </div>
                            <div class="text-center">
