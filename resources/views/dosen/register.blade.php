                ...
                <div class="row">
                    <div class="col-lg my-4">
                        <div class="p-5">
                            ...
                            <form class="user" method="post" action="/dosen/proses_register">
                                @csrf
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="name" name="nip" placeholder="Nip">
                                </div>
                                <div class="form-group">
                            ...
                            <hr>
                            <div class="text-center">
                                <a class="small" href="/dosen/auth">Already have an account? Login!</a>
                            </div>
                            <div class="text-center">
