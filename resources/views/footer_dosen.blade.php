    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="/dosen/logout">Logout</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#tambah").click(function(){
           ...
           for (var i=1; i<=str; i++){
               var text1 = "<div id='card-soal' class='card mb-3 mt-3'>\n" +
                   "                        <div class='card-body'>\n" +
                   "                            <div class='form-group'>\n" +
                   ...
                   "                            </div>\n" +
                   "                            <div class='form-group'>\n" +
                   "                                <input type='text' class='form-control' id='kunci' placeholder='Masukkan Kunci Jawaban'\n" +
                   "                                       name='kunci["+i+"]' value=''>\n" +
                   "                            </div>\n" +
                   "                        </div>\n" +
                   "                    </div>";
